      ...
      <div class="row">
        <div class="col-lg-3 col-sm-3 col-xs-12">
          <div class="white-box analytics-info">
            <h3 class="box-title">Total Income Today</h3>
            <ul class="list-inline two-part">
              <li>
                <div id="sparklinedash"></div>
              </li>
              <li class="text-right"><i class="fa fa-usd text-success"></i> <span class="counter text-success"><?php echo $TodayIN; ?></span></li>
            </ul>
          </div>
        </div>
        <div class="col-lg-3 col-sm-3 col-xs-12">
          <div class="white-box analytics-info">
            <h3 class="box-title">Total Income Week</h3>
            <ul class="list-inline two-part">
              <li>
                <div id="sparklinedash2"></div>
              </li>
              <li class="text-right"><i class="fa fa-usd text-purple"></i> <span class="counter text-purple"><?php echo $WeekIN; ?></span></li>
            </ul>
          </div>
        </div>
        <div class="col-lg-3 col-sm-3 col-xs-12">
          <div class="white-box analytics-info">
            <h3 class="box-title">Total Income Month</h3>
            <ul class="list-inline two-part">
              <li>
                <div id="sparklinedash3"></div>
              </li>
              <li class="text-right"><i class="fa fa-usd text-info"></i> <span class="counter text-info"><?php echo $MonthIN; ?></span></li>
            </ul>
          </div>
        </div>
        <div class="col-lg-3 col-sm-3 col-xs-12">
          <div class="white-box analytics-info">
            ...
            <ul class="list-inline two-part">
              ...
              <li class="text-right"><i class="fa fa-usd text-danger"></i> <span class="text-danger"><?php echo $TotalIN; ?></span></li>
            </ul>
          </div>
        </div>
      </div>

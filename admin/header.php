  ...
  <div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
      <ul class="nav" id="side-menu">
		...
		<li> <a href="psettings.php" class="waves-effect"> <span class="hide-menu"> Payment Settings </span></a></li>
		<li> <a href="esettings.php" class="waves-effect"> <span class="hide-menu"> Email Settings </span></a></li>
        </ul>
        </li>
		...
		<li> <a href="support.php" class="waves-effect"><span class="hide-menu"> Support Tickets </span></a></li>
        </ul>
        </li>
        </li>
		<?php
		...
		<li> <a href="#" class="waves-effect "><i data-icon="&#xe008;" class="fa fa-sticky-note fa-fw"></i> <span class="hide-menu">Logs<span class="fa arrow"></span></span></a>
          <ul class="nav nav-second-level">
		<li> <a href="plogs.php" class="waves-effect"> <span class="hide-menu"> Payments </a></li>
		...
		<li> <a href="alogs.php" class="waves-effect"> <span class="hide-menu"> API Logs </span></a></li>
          </ul>
        </li>
		...
		<li> <a href="adminhub.php" class="waves-effect"><i class="fa fa-bomb fa-fw" data-icon="v"></i> <span class="hide-menu"> Attack Hub </span></a></li>
